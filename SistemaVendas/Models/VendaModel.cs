    ...
    public class VendaModel
    {
       ...
       // Para atender o filtro do relatorio
        ...
        private List<VendaModel> RetornarListagemVendas(string DataDe, string DataAte)
        {
            ...
            VendaModel item;
            DAL objDAL = new DAL();
            string sql = "select v1.id, v1.data, v1.total, v2.nome as vendedor," +
                " c.nome as cliente from venda v1 inner join vendedor v2 " +
                " on v1.vendedor_id = v2.id " +
        ...
        public void Inserir()
        {
           ...
           // Deserializar o JSON da lista de produto selecionadas e grava-los na tabela itens_venda
            ...
            for (int i = 0; i < lista_produtos.Count; i++)
            {
               ...
               objDAL.ExecutarComandoSQL(sql);
                ...
                sql = "update produto set " +
                    $"quantidade_estoque = (quantidade_estoque - " + int.Parse(lista_produtos[i].QtdeProduto.ToString()) + ") " +
